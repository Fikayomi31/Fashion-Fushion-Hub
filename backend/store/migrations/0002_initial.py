...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='coupon',
            name='user_by',
            field=models.ManyToManyField(blank=True, related_name='coupons_used', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='coupon',
            name='vendor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coupons_provided', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
